...
Message.createFromBuffer = function(buffer, mode) {
  ...
  var binary = new Buffer(hex.substring(0, hex.length - 8), 'hex');
...
Message.parseCommandResult = function(code, buffer) {
  ...
  function parseCoords(ascii) {
    ...
    return {
      ...
      heading       : typeof part2[7] !== 'undefined' ? parseFloat(part1[7]) : null,
      altitude      : parseFloat(part2[2]),
      ioStatus      : part2[3],
      analogInput   : typeof part2[4] !== 'undefined' ? part2[4].split(',') : null,
      baseStationId : typeof part2[5] !== 'undefined' ? part2[5] : null,
      csq           : typeof part2[6] !== 'undefined' ? parseFloat(part2[6]) : null,
      journey       : typeof part2[7] !== 'undefined' ? parseInt(part2[7], 10) : null,
